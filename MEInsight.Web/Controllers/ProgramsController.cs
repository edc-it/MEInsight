...
namespace MEL.Web.Controllers
{
    ...
    public class ProgramsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProgramId,ProgramName,RefProgramTypeId,RefProgramDeliveryTypeId,Description,Max,Min,RefAttendanceUnitId,HasAssessment,DisplayMarks,RefOrganizationTypeId")] MEInsight.Entities.Programs.Program program)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProgramId,ProgramName,RefProgramTypeId,RefProgramDeliveryTypeId,Description,Max,Min,RefAttendanceUnitId,HasAssessment,DisplayMarks,RefOrganizationTypeId")] MEInsight.Entities.Programs.Program program)
        {
