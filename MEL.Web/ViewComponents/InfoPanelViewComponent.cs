            ...
            switch (controller)
            {
                ...
                case "GroupEnrollments":
                    ...
                    model = new InfoPanelViewModel
                    {
                        ...
                        GroupTeacher = groupEnrollment.Teachers?.Participants?.NameId ?? null,
                        GroupTeacherType = groupEnrollment.Teachers?.Participants?.ParticipantTypes?.ParticipantType ?? null,
